...
class UpdataConsistency(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        self.add_arp_flow(datapath, False)
        self.add_forward_flow(datapath, port_s1_h1)

        time.sleep(update_after)
        LOG.info("Update now!")

        self.add_forward_flow(datapath, port_s1_h2)
    ...
    def add_forward_flow(self, datapath, out_port):
        ofproto = datapath.ofproto
        ...
        match = parser.OFPMatch(
            in_port=port_s1_client, eth_type=0x800, ip_proto=6)
    ...
    def add_arp_flow(self, datapath, table_miss=False):
        ofproto = datapath.ofproto
        parser = datapath.ofproto_parser
